...
myappsmenu = {
   ...
   { "sunrise", function() awful.util.spawn("chromium --app-id=mojepfklcankkmikonjlnidiooanmpbb") end},
   { "ticktick", function() awful.util.spawn("chromium \"--profile-directory=Profile 1\" --app-id=eempgbpncmilmobpbhbfpdjdcpgd") end},
   { "gimp", function() awful.util.spawn("gimp") end},
...
mymainmenu = awful.menu.new({ items = { 
                                        ...
                                        { "Brightness 250", function() os.execute("sudo echo 250 > /sys/class/backlight/mba6x_backlight/brightness") end},
