...
--    awful.key({ modkey,           }, "<", function () awful.util.spawn("sh /home/raph/scripts/dmenu.sh")       end),
    awful.key({ modkey,           }, "<", function () awful.util.spawn("dmenu_run -i -b -f -p 'Run command:' -nb '" .. "#506070" .. "' -nf '" .. beautiful.fg_normal .. "' -sb '" .. beautiful.border_focus .. "' -sf '" .. beautiful.border_normal .. "' -fn '-*-liberation mono-*-r-*-*-*-120-*-*-*-*-*-*'") end), 
