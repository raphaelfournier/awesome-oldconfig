...
--    awful.key({ modkey, "Shift"   }, "w", function () awful.util.spawn("urxvtc -name ncmpcpp -e ncmpcpp")            end),
...
awful.key({modkey, "Shift"}, "c", shifty.send_prev), -- client to prev tag
awful.key({modkey}, "c", shifty.send_next), -- client to next tag
